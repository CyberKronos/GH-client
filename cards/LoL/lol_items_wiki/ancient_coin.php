...
<div class='client-pin'>
  ...
  <span class="lol-icon large with-tooltip"> <span style="background:url(//lkimg.zamimg.com/shared/riot/images/items/3301_64.png)no-repeat; display: inline-block; width: 90px; height: 90px;"></span><a class="no-href"></a><!-- if this were an icon we want to actually link to somewhere: <a href="http://www.lolking.net/item/123/the-bloodthirster"> --> </span>
  <div class="lol-tt-cost">
										Cost: <em class="lol-money gold upgrade-cost">365</em>
									</div>
    <br/>
  <div class="lol-tt-desc">
								       <span>+5 Health Regen per 5 seconds</span><br><span>+3 Mana Regen per 5 seconds</span><br><br><strong>UNIQUE Passive</strong> - Favor: Being near a minion death without dealing the killing blow grants 2 Gold.<br><br>Limited to 1 Gold Income item<br><br>''Gold dust rises from the desert and clings to the coin.'' - Historian Shurelya, 11 November, 23 CLE								       									</div>
  </div>
</div>
</div>
