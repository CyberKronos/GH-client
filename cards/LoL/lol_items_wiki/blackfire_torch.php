...
<div class='client-pin'>
  ...
  <span class="lol-icon large with-tooltip"> <span style="background:url(//lkimg.zamimg.com/shared/riot/images/items/3188_64.png)no-repeat; display: inline-block; width: 90px; height: 90px;"></span><a class="no-href"></a><!-- if this were an icon we want to actually link to somewhere: <a href="http://www.lolking.net/item/123/the-bloodthirster"> --> </span>
  <div class="lol-tt-cost">
										Cost: <em class="lol-money gold upgrade-cost">2650</em>
									</div>
    <br/>
  <div class="lol-tt-desc">
								       <span>+80 Ability Power</span><br><span>+10% Cooldown Reduction</span><br><span>+10% Movement Speed</span><br><br><strong>UNIQUE Active:</strong> Deals 20% of target champion's maximum Health in magic damage over 4 seconds and increases all subsequent magic damage taken by the target by 20% (60 second cooldown).								       									</div>
  </div>
</div>
</div>
</body>
