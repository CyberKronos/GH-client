...
<div class='client-pin'>
  ...
  <span class="lol-icon large with-tooltip"> <span style="background:url(//lkimg.zamimg.com/shared/riot/images/items/3044_64.png)no-repeat; display: inline-block; width: 90px; height: 90px;"></span><a class="no-href"></a><!-- if this were an icon we want to actually link to somewhere: <a href="http://www.lolking.net/item/123/the-bloodthirster"> --> </span>
  <div class="lol-tt-cost">
										Cost: <em class="lol-money gold upgrade-cost">1325</em>
									</div>
    <br/>
  <div class="lol-tt-desc">
								       <span>+200 Health</span><br><span>+20 Attack Damage</span><br><br><strong>UNIQUE Passive</strong> - Rage: Basic attacks grant 20 Movement Speed for 2 seconds. Kills grant 60 Movement Speed instead. This Movement Speed bonus is halved for ranged champions.<br><br>(Unique Passives with the same name don't stack.)								       									</div>
  </div>
</div>
</div>
</body>
