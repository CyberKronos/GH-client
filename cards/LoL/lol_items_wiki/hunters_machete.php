...
<div class='client-pin'>
  <h4 class='title'><b>
										Hunter's Machete									</b></h4>
  <h5 class='sub-title'><b>Item Wiki</b></h5>
  
  <div class='client-pin-content-holder'>
  <span class="lol-icon large with-tooltip"> <span style="background:url(//lkimg.zamimg.com/shared/riot/images/items/1039_64.png)no-repeat; display: inline-block; width: 90px; height: 90px;"></span><a class="no-href"></a><!-- if this were an icon we want to actually link to somewhere: <a href="http://www.lolking.net/item/123/the-bloodthirster"> --> </span>
  <div class="lol-tt-cost">
										Cost: <em class="lol-money gold upgrade-cost">300</em>
									</div>
    <br/>
  <div class="lol-tt-desc">
								       <strong>UNIQUE Passive</strong> - Maim: Basic attacks against monsters deal 10 bonus magic damage and heal 5 Health on hit.<br><strong>UNIQUE Passive</strong> - Butcher: Deal 10% bonus damage to monsters.<br><br>(Unique Passives with the same name don't stack.)								       									</div>
  </div>
</div>
</div>
</body>
