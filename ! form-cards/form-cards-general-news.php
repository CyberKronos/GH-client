...
if(isset($_POST['formSubmit']) == "Submit")
{
	...
	$varImageName = $_POST['formBannerImageName'];
...
<div class="client-pin">
  ...
  <div class="client-pin-content-holder">
  	<p> 
      <img class="rounded_pics" src="images/news_pics/$varBannerImageName.jpg">
    </p>
    $varTopBody
  </div>
  <br/>
...
<body>
	...
	?>
	<form action="form-cards-general-news.php" method="post">
		<p>
			Enter File Name<br>
